(function() {
  ...
  (function(exports) {
    ...
    return exports.generate = generate = function(ast, options) {
      var a, absNum, arg, args, expression_, hasAlternate, i, isMultiline, key_, m, memberAccessOps, members_, needsParens, p, parameters, parent, parentClassName, prec, s, sep, src, usedAsExpression, _alternate, _argList, _args, _assignee, _block, _body, _consequent, _ctor, _expr, _fn, _indexingExpr, _left, _op, _paramList, _right;
      if (options == null) {
        options = {};
      }
      needsParens = false;
      if (options.precedence == null) {
        options.precedence = 0;
      }
      if (options.ancestors == null) {
        options.ancestors = [];
      }
      ...
      src = (function() {
        var _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
        switch (ast.className) {
          case 'Program':
          ...
          case 'Conditional':
            ...
            _consequent = generate((_ref = ast.consequent) != null ? _ref : (new Undefined).g(), options);
          ...
          case 'ObjectInitialiserMember':
            ...
            if (eq(ast.key, ast.expression)) {
              return "" + key_;
            } else if ((_ref1 = ast.expression.className, __indexOf.call(memberAccessOps, _ref1) >= 0) && ast.key.data === ast.expression.memberName) {
              return "" + expression_;
            } else {
          ...
          case 'PreDecrementOp':
            ...
            if (ast.className === 'LogicalNotOp') {
              if ((_ref3 = ast.expression.className) === 'InOp' || _ref3 === 'OfOp' || _ref3 === 'InstanceofOp') {
                _op = '';
